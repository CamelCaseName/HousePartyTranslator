...
{
    public class WinSettings : Core.UICompatibilityLayer.ISettings
    {
        ...
        public static float IdealLength { get => Settings.Default.idealLength; set => Settings.Default.idealLength = value; }
        public static int ColoringDepth { get => Settings.Default.coloringDepth; set => Settings.Default.coloringDepth = value; }
        ...
        public static void Upgrade() => Settings.Default.Upgrade();
    }
}
