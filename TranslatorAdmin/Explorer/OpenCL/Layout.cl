...
__kernel void layout_kernel(
	...
	//fix for the iterations we run too much, for filling up every warp we run some empty and its faster to keep it parallel
	if (global_i >= actual_node_count) global_i = 0;
