...
public sealed unsafe class OpenCLManager
{
    ...
    public void CalculateLayout(Action? FrameRenderedCallback, CancellationToken token)
    {
    ...
    public (int[] node_this_indices, int[] node_child_indices) GetEdgeBuffers(int localWorkGroupSize)
    {
    ...
    public void SetNewNodePositions(float[] returnedNodePositionBuffer)
    {
